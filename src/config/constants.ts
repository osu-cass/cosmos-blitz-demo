...
export const PICKUP_CONFIG = {
  ...
  laserTickMs: 140,
  shotgunSize: 24,
  shotgunSpawnMinMs: 12000,
  shotgunSpawnMaxMs: 18000,
  shotgunLifetimeMs: 9000,
  shotgunDurationMs: 7000,
  shotgunShootCooldownMs: 420,
  shotgunPelletCount: 5,
  shotgunSpreadRadians: 0.16,
  shotgunPelletHealAmount: 2,
  healthSize: 26,
